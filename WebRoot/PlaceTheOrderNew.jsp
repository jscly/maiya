...
<!--top-header-->
  ...
  %>
    ...
    cartId：<%=request.getParameter("cartId") %><br> --%>
  	...
  	if(cartService.CustomerAddOrder(Integer.parseInt(request.getParameter("customerId")), Integer.parseInt(request.getParameter("cartId")))){
  	 ...
  	 下单成功！
  	 <a href="CustomerOrderNew.jsp?cartId=<%=request.getParameter("cartId") %>">前往订单页面</a>
  	 <%
