...
<!--top-header-->
  ...
  %>
   <%--  customerId：<%=request.getParameter("customerId") %><br>
    cartId：<%=request.getParameter("cartId") %><br>
    requestCode：<%=request.getParameter("requestCode") %> --%>
  	
  	<%
  	CartService cartService = new CartService();
  	
  	if(cartService.CustomerDelCart(Integer.parseInt(request.getParameter("customerId")), Integer.parseInt(request.getParameter("cartId")), Integer.parseInt(request.getParameter("requestCode")))){
  	
  	
  	 %>
	<div class="tab1">删除成功！&nbsp;&nbsp;&nbsp;<a href="CartNew.jsp">返回</a></div>  
  <%
